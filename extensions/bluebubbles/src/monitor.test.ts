...
import { removeAckReactionAfterReply, shouldAckReaction } from "gimli/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/gimli") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
