...
### Changes
- Version alignment with core Gimli release numbers.
...
### Highlights
- First public release of the @gimli/voice-call plugin.
...
- CLI: `gimli voicecall` commands (call/start/continue/speak/end/status/tail/expose).
