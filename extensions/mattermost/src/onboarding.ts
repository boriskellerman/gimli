import type { ChannelOnboardingAdapter, GimliConfig, WizardPrompter } from "gimli/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.gimli.bot/channels/mattermost",
    ].join("\n"),
