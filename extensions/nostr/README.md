...
Nostr DM channel plugin for Gimli using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Gimli. It enables your bot to:
...
# Configure gimli to use local relay
