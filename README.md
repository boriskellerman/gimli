...
<p align="center">
  <a href="https://github.com/gimli/gimli/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/gimli/gimli/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/gimli/gimli/releases"><img src="https://img.shields.io/github/v/release/gimli/gimli?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://deepwiki.com/gimli/gimli"><img src="https://img.shields.io/badge/DeepWiki-gimli-111111?style=for-the-badge" alt="DeepWiki"></a>
  <a href="https://discord.gg/gimli"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Gimli** is a *personal AI assistant* you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://gimli.bot) · [Docs](https://docs.gimli.bot) · [Getting Started](https://docs.gimli.bot/start/getting-started) · [Updating](https://docs.gimli.bot/install/updating) · [Showcase](https://docs.gimli.bot/start/showcase) · [FAQ](https://docs.gimli.bot/start/faq) · [Wizard](https://docs.gimli.bot/start/wizard) · [Nix](https://github.com/gimli/nix-gimli) · [Docker](https://docs.gimli.bot/install/docker) · [Discord](https://discord.gg/gimli)

Preferred setup: run the onboarding wizard (`gimli onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.gimli.bot/start/getting-started)

**Subscriptions (OAuth):**
- **[Anthropic](https://www.anthropic.com/)** (Claude Pro/Max)
- **[OpenAI](https://openai.com/)** (ChatGPT/Codex)

Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.gimli.bot/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.gimli.bot/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.gimli.bot/concepts/model-failover)
...
# or: pnpm add -g gimli@latest

gimli onboard --install-daemon
```

The wizard installs the Gateway daemon (launchd/systemd user service) so it stays running.
Legacy note: `gimli` remains available as a compatibility shim.

## Quick start (TL;DR)

Runtime: **Node ≥22**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.gimli.bot/start/getting-started)

```bash
gimli onboard --install-daemon

gimli gateway --port 18789 --verbose

# Send a message
gimli message send --to +1234567890 --message "Hello from Gimli"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
gimli agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.gimli.bot/install/updating) (and run `gimli doctor`).
...
Switch channels (git + npm): `gimli update --channel stable|beta|dev`.
Details: [Development channels](https://docs.gimli.bot/install/development-channels).
...
pnpm gimli onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm gimli ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `gimli` binary.

## Security defaults (DM access)

Gimli connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.gimli.bot/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:
- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `gimli pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `gimli doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.gimli.bot/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.gimli.bot/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.gimli.bot/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.gimli.bot/nodes/voicewake) + [Talk Mode](https://docs.gimli.bot/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.gimli.bot/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.gimli.bot/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.gimli.bot/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.gimli.bot/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.gimli.bot/nodes).
- **[Onboarding](https://docs.gimli.bot/start/wizard) + [skills](https://docs.gimli.bot/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=gimli/gimli&type=date&legend=top-left)](https://www.star-history.com/#gimli/gimli&type=date&legend=top-left)

## Everything we built so far

### Core platform
- [Gateway WS control plane](https://docs.gimli.bot/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.gimli.bot/web), and [Canvas host](https://docs.gimli.bot/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.gimli.bot/tools/agent-send): gateway, agent, send, [wizard](https://docs.gimli.bot/start/wizard), and [doctor](https://docs.gimli.bot/gateway/doctor).
- [Pi agent runtime](https://docs.gimli.bot/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.gimli.bot/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.gimli.bot/concepts/groups).
- [Media pipeline](https://docs.gimli.bot/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.gimli.bot/nodes/audio).

### Channels
- [Channels](https://docs.gimli.bot/channels): [WhatsApp](https://docs.gimli.bot/channels/whatsapp) (Baileys), [Telegram](https://docs.gimli.bot/channels/telegram) (grammY), [Slack](https://docs.gimli.bot/channels/slack) (Bolt), [Discord](https://docs.gimli.bot/channels/discord) (discord.js), [Google Chat](https://docs.gimli.bot/channels/googlechat) (Chat API), [Signal](https://docs.gimli.bot/channels/signal) (signal-cli), [iMessage](https://docs.gimli.bot/channels/imessage) (imsg), [BlueBubbles](https://docs.gimli.bot/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.gimli.bot/channels/msteams) (extension), [Matrix](https://docs.gimli.bot/channels/matrix) (extension), [Zalo](https://docs.gimli.bot/channels/zalo) (extension), [Zalo Personal](https://docs.gimli.bot/channels/zalouser) (extension), [WebChat](https://docs.gimli.bot/web/webchat).
- [Group routing](https://docs.gimli.bot/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.gimli.bot/channels).

### Apps + nodes
- [macOS app](https://docs.gimli.bot/platforms/macos): menu bar control plane, [Voice Wake](https://docs.gimli.bot/nodes/voicewake)/PTT, [Talk Mode](https://docs.gimli.bot/nodes/talk) overlay, [WebChat](https://docs.gimli.bot/web/webchat), debug tools, [remote gateway](https://docs.gimli.bot/gateway/remote) control.
- [iOS node](https://docs.gimli.bot/platforms/ios): [Canvas](https://docs.gimli.bot/platforms/mac/canvas), [Voice Wake](https://docs.gimli.bot/nodes/voicewake), [Talk Mode](https://docs.gimli.bot/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.gimli.bot/platforms/android): [Canvas](https://docs.gimli.bot/platforms/mac/canvas), [Talk Mode](https://docs.gimli.bot/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.gimli.bot/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation
- [Browser control](https://docs.gimli.bot/tools/browser): dedicated gimli Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.gimli.bot/platforms/mac/canvas): [A2UI](https://docs.gimli.bot/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.gimli.bot/nodes): camera snap/clip, screen record, [location.get](https://docs.gimli.bot/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.gimli.bot/automation/cron-jobs); [webhooks](https://docs.gimli.bot/automation/webhook); [Gmail Pub/Sub](https://docs.gimli.bot/automation/gmail-pubsub).
- [Skills platform](https://docs.gimli.bot/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety
- [Channel routing](https://docs.gimli.bot/concepts/channel-routing), [retry policy](https://docs.gimli.bot/concepts/retry), and [streaming/chunking](https://docs.gimli.bot/concepts/streaming).
- [Presence](https://docs.gimli.bot/concepts/presence), [typing indicators](https://docs.gimli.bot/concepts/typing-indicators), and [usage tracking](https://docs.gimli.bot/concepts/usage-tracking).
- [Models](https://docs.gimli.bot/concepts/models), [model failover](https://docs.gimli.bot/concepts/model-failover), and [session pruning](https://docs.gimli.bot/concepts/session-pruning).
- [Security](https://docs.gimli.bot/gateway/security) and [troubleshooting](https://docs.gimli.bot/channels/troubleshooting).

### Ops + packaging
- [Control UI](https://docs.gimli.bot/web) + [WebChat](https://docs.gimli.bot/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.gimli.bot/gateway/tailscale) or [SSH tunnels](https://docs.gimli.bot/gateway/remote) with token/password auth.
- [Nix mode](https://docs.gimli.bot/install/nix) for declarative config; [Docker](https://docs.gimli.bot/install/docker)-based installs.
- [Doctor](https://docs.gimli.bot/gateway/doctor) migrations, [logging](https://docs.gimli.bot/logging).
...
- **[Gateway WebSocket network](https://docs.gimli.bot/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.gimli.bot/gateway)).
- **[Tailscale exposure](https://docs.gimli.bot/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.gimli.bot/gateway/remote)).
- **[Browser control](https://docs.gimli.bot/tools/browser)** — gimli‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.gimli.bot/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.gimli.bot/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.gimli.bot/nodes/voicewake) + [Talk Mode](https://docs.gimli.bot/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.gimli.bot/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

Gimli can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
Notes:
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Gimli enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.gimli.bot/gateway/tailscale) · [Web surfaces](https://docs.gimli.bot/web)
...
Details: [Remote access](https://docs.gimli.bot/gateway/remote) · [Nodes](https://docs.gimli.bot/nodes) · [Security](https://docs.gimli.bot/gateway/security)
...
Details: [Nodes](https://docs.gimli.bot/nodes) · [macOS app](https://docs.gimli.bot/platforms/macos) · [Gateway protocol](https://docs.gimli.bot/concepts/architecture)
...
Details: [Session tools](https://docs.gimli.bot/concepts/session-tool)

## Skills registry (GimliHub)

GimliHub is a minimal skill registry. With GimliHub enabled, the agent can search for skills automatically and pull in new ones as needed.
...
- Controlled via `gimli nodes …`.

Runbook: [iOS connect](https://docs.gimli.bot/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.gimli.bot/platforms/android).

## Agent workspace + skills

- Workspace root: `~/gimli` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/gimli/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.gimli/gimli.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.gimli.bot/gateway/configuration)
...
Details: [Security guide](https://docs.gimli.bot/gateway/security) · [Docker + sandboxing](https://docs.gimli.bot/install/docker) · [Sandbox config](https://docs.gimli.bot/gateway/configuration)

### [WhatsApp](https://docs.gimli.bot/channels/whatsapp)

- Link the device: `pnpm gimli channels login` (stores creds in `~/.gimli/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.gimli.bot/channels/telegram)
...
### [Slack](https://docs.gimli.bot/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.gimli.bot/channels/discord)
...
### [Signal](https://docs.gimli.bot/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.gimli.bot/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.gimli.bot/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.gimli.bot/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.gimli.bot)
- [Read the architecture overview for the gateway + protocol model.](https://docs.gimli.bot/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.gimli.bot/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.gimli.bot/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.gimli.bot/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.gimli.bot/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.gimli.bot/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.gimli.bot/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.gimli.bot/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.gimli.bot/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.gimli.bot/platforms/windows), [Linux](https://docs.gimli.bot/platforms/linux), [macOS](https://docs.gimli.bot/platforms/macos), [iOS](https://docs.gimli.bot/platforms/ios), [Android](https://docs.gimli.bot/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.gimli.bot/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.gimli.bot/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.gimli.bot/gateway/discovery)
- [Bonjour/mDNS](https://docs.gimli.bot/gateway/bonjour)
- [Gateway pairing](https://docs.gimli.bot/gateway/pairing)
- [Remote gateway README](https://docs.gimli.bot/gateway/remote-gateway-readme)
- [Control UI](https://docs.gimli.bot/web/control-ui)
- [Dashboard](https://docs.gimli.bot/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.gimli.bot/gateway/health)
- [Gateway lock](https://docs.gimli.bot/gateway/gateway-lock)
- [Background process](https://docs.gimli.bot/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.gimli.bot/tools/browser-linux-troubleshooting)
- [Logging](https://docs.gimli.bot/logging)

## Deep dives

- [Agent loop](https://docs.gimli.bot/concepts/agent-loop)
- [Presence](https://docs.gimli.bot/concepts/presence)
- [TypeBox schemas](https://docs.gimli.bot/concepts/typebox)
- [RPC adapters](https://docs.gimli.bot/reference/rpc)
- [Queue](https://docs.gimli.bot/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.gimli.bot/tools/skills-config)
- [Default AGENTS](https://docs.gimli.bot/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.gimli.bot/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.gimli.bot/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.gimli.bot/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.gimli.bot/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.gimli.bot/reference/templates/TOOLS)
- [Templates: USER](https://docs.gimli.bot/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.gimli.bot/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.gimli.bot/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.gimli.bot/platforms/mac/voicewake)
- [iOS node](https://docs.gimli.bot/platforms/ios)
- [Android node](https://docs.gimli.bot/platforms/android)
- [Windows (WSL2)](https://docs.gimli.bot/platforms/windows)
- [Linux app](https://docs.gimli.bot/platforms/linux)

## Email hooks (Gmail)

- [docs.gimli.bot/gmail-pubsub](https://docs.gimli.bot/automation/gmail-pubsub)
