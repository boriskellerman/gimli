...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@gimli", { botUsername: "gimli" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@gimli args", {
        botUsername: "gimli",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "gimli" })).toBe("/help@otherbot");
  });
