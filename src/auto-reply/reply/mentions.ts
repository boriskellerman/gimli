...
function resolveMentionPatterns(cfg: GimliConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: GimliConfig | undefined, agentId?: string): RegExp[] {
