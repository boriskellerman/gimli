...
export function applyZaiConfig(cfg: GimliConfig): GimliConfig {
...
export function applyOpenrouterProviderConfig(cfg: GimliConfig): GimliConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: GimliConfig): GimliConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: GimliConfig): GimliConfig {
...
export function applyOpenrouterConfig(cfg: GimliConfig): GimliConfig {
...
export function applyMoonshotProviderConfig(cfg: GimliConfig): GimliConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: GimliConfig): GimliConfig {
...
export function applyKimiCodeProviderConfig(cfg: GimliConfig): GimliConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: GimliConfig): GimliConfig {
...
export function applySyntheticProviderConfig(cfg: GimliConfig): GimliConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: GimliConfig): GimliConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: GimliConfig): GimliConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: GimliConfig): GimliConfig {
