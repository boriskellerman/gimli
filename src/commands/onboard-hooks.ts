...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.gimli.bot/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("gimli hooks list")}`,
      `  ${formatCliCommand("gimli hooks enable <name>")}`,
      `  ${formatCliCommand("gimli hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
