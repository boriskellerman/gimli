...
describe("detectLegacyWorkspaceDirs", () => {
  it("ignores ~/gimli when it doesn't look like a workspace (e.g. install dir)", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/gimli";
    const candidate = path.join(home, "gimli");
  ...
  it("flags ~/gimli when it contains workspace markers", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/gimli";
    const candidate = path.join(home, "gimli");
