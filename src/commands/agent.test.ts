...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "gimli-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<GimliConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<GimliConfig["telegram"]>>,
