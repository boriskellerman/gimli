...
import { type GimliConfig, readConfigFileSnapshot, writeConfigFile } from "../../config/config.js";
...
export async function updateConfig(
  mutator: (cfg: GimliConfig) => GimliConfig,
): Promise<GimliConfig> {
...
export function resolveModelTarget(params: { raw: string; cfg: GimliConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: GimliConfig): Set<string> {
