...
import type { GimliConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: GimliConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: GimliConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: GimliConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: GimliConfig) => void;
  log: {
