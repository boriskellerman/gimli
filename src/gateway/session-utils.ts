...
import { type GimliConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: GimliConfig): string[] {
...
export function listAgentsForGateway(cfg: GimliConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: GimliConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: GimliConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: GimliConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: GimliConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: GimliConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: GimliConfig): GatewaySessionsDefaults {
