...
export function resolveTtsConfig(cfg: GimliConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.GIMLI_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: GimliConfig): string | undefined {
