const DEFAULT_TAGLINE = "All your chats, one Gimli.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little axe-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just got an axe—type something and let the bot cleave the busywork.",
  ...
  "Automation with axes: minimal fuss, maximal cleave.",
  ...
  "I'll forge your workflow like dwarven steel: sturdy, reliable, effective.",
  "Shell yeah—I'm here to axe the toil and leave you the glory.",
  ...
  "The only dwarf in your contacts who actually answers. 🪓",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.GIMLI_TAGLINE_INDEX;
