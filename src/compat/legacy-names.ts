export const LEGACY_PROJECT_NAME = "gimli" as const;
...
export const LEGACY_MACOS_APP_SOURCES_DIR = "apps/macos/Sources/Gimli" as const;

export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/Gimli" as const;
