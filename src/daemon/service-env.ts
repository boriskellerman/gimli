...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    GIMLI_PROFILE: profile,
    GIMLI_STATE_DIR: env.GIMLI_STATE_DIR,
    GIMLI_CONFIG_PATH: env.GIMLI_CONFIG_PATH,
    GIMLI_GATEWAY_PORT: String(port),
    GIMLI_GATEWAY_TOKEN: token,
    GIMLI_LAUNCHD_LABEL: resolvedLaunchdLabel,
    GIMLI_SYSTEMD_UNIT: systemdUnit,
    GIMLI_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    GIMLI_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    GIMLI_STATE_DIR: env.GIMLI_STATE_DIR,
    GIMLI_CONFIG_PATH: env.GIMLI_CONFIG_PATH,
    GIMLI_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    GIMLI_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    GIMLI_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    GIMLI_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    GIMLI_LOG_PREFIX: "node",
    GIMLI_SERVICE_MARKER: NODE_SERVICE_MARKER,
    GIMLI_SERVICE_KIND: NODE_SERVICE_KIND,
    GIMLI_SERVICE_VERSION: VERSION,
  };
}
