...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof GimliConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: GimliConfig; env: NodeJS.ProcessEnv }): {
  cfg: GimliConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
