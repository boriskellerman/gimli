...
export function listBindings(cfg: GimliConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: GimliConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: GimliConfig) {
