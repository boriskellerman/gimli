...
export const A2UI_PATH = "/__gimli__/a2ui";
export const CANVAS_HOST_PATH = "/__gimli__/canvas";
export const CANVAS_WS_PATH = "/__gimli/ws";
...
(() => {
  ...
  const handlerNames = ["gimliCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Gimli = globalThis.Gimli ?? {};
  globalThis.Gimli.postMessage = postToNode;
  globalThis.Gimli.sendUserAction = sendUserAction;
  globalThis.gimliPostMessage = postToNode;
  globalThis.gimliSendUserAction = sendUserAction;
  globalThis.gimliPostMessage = postToNode;
  globalThis.gimliSendUserAction = sendUserAction;
