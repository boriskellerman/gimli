...
export const PLUGIN_MANIFEST_FILENAME = "gimli.plugin.json";
...
// package.json "gimli" metadata (used for onboarding/catalog)
...
export type GimliPackageManifest = {
  extensions?: string[];
...
): GimliPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.gimli ?? manifest[LEGACY_MANIFEST_KEY];
}
