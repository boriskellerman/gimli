...
function resolveAnthropicDefaultAuthMode(cfg: GimliConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: GimliConfig): GimliConfig {
...
export function applyTalkApiKey(config: GimliConfig): GimliConfig {
...
export function applyModelDefaults(cfg: GimliConfig): GimliConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: GimliConfig): GimliConfig {
...
export function applyLoggingDefaults(cfg: GimliConfig): GimliConfig {
...
export function applyContextPruningDefaults(cfg: GimliConfig): GimliConfig {
...
export function applyCompactionDefaults(cfg: GimliConfig): GimliConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
