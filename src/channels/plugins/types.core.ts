...
export type ChannelAgentToolFactory = (params: { cfg?: GimliConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: GimliConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: GimliConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: GimliConfig }) => boolean;
  supportsCards?: (params: { cfg: GimliConfig }) => boolean;
