...
export function listChannelMessageActions(cfg: GimliConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: GimliConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: GimliConfig): boolean {
  for (const plugin of listChannelPlugins()) {
