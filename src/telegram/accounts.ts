...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.GIMLI_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: GimliConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: GimliConfig): string {
...
function mergeTelegramAccountConfig(cfg: GimliConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: GimliConfig): ResolvedTelegramAccount[] {
