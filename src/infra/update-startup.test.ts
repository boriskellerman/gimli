...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "gimli-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveGimliPackageRoot } = await import("./gimli-root.js");
    ...
    vi.mocked(resolveGimliPackageRoot).mockResolvedValue("/opt/gimli");
