...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: GimliConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: GimliConfig): Promise<MessageChannelId[]> {
