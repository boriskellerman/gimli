...
describe("createGimliCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createGimliCodingTools({
      config,
    ...
    const anthropicTools = createGimliCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createGimliCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createGimliCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
