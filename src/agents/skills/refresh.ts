...
function resolveWatchPaths(workspaceDir: string, config?: GimliConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: GimliConfig }) {
