...
import type { GimliConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: GimliConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: GimliConfig | undefined, pathStr: string): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "gimli-bundled";
}

export function resolveBundledAllowlist(config?: GimliConfig): string[] | undefined {
