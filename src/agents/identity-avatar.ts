...
function resolveAvatarSource(cfg: GimliConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: GimliConfig, agentId: string): AgentAvatarResolution {
