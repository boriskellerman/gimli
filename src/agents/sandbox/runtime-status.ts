...
function resolveMainSessionKeyForSandbox(params: { cfg?: GimliConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: GimliConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(`- See: ${formatCliCommand(`gimli sandbox explain --session ${runtime.sessionKey}`)}`);
