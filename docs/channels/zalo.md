...
- Install via CLI: `gimli plugins install @gimli/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `gimli plugins install ./extensions/zalo`
   - From npm (if published): `gimli plugins install @gimli/zalo`
...
- Approve via:
  - `gimli pairing list zalo`
  - `gimli pairing approve zalo <CODE>`
...
- Example: `gimli message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `gimli channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `gimli logs --follow`
