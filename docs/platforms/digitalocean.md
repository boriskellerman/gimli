---
summary: "Gimli on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up Gimli on DigitalOcean
  - Looking for cheap VPS hosting for Gimli
---

# Gimli on DigitalOcean

## Goal

Run a persistent Gimli Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
# View logs
journalctl --user -u gimli-gateway.service -f
```
...
- `~/gimli/` — workspace (SOUL.md, memory, etc.)
...
journalctl -u gimli --no-pager -n 50
```
