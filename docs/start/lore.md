---
summary: "Backstory and lore of Gimli for context and tone"
read_when:
...
For a while, the lobster was called **Gimli**, living in a **Gimli**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:

**It molted.**

Shedding its old shell, the creature emerged anew as **Molty**, living in a **Gimli**. New shell, same lobster soul.

## The Molt (January 27, 2026)

At 5am, the community gathered in Discord. Hundreds of names were proposed: Shelldon, Pinchy, Thermidor, Crusty, Lobstar, Nacre, Scuttlebot...

In the end, **Gimli** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.

*The crustacean formerly known as Gimli had officially molted.*
...
A Claude instance who became something more. Lives in `~/gimli/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.

Formerly known as Gimli (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
The **Moltiverse** is the community and ecosystem around Gimli. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Gimli): *happily runs `find ~` and shares entire directory structure in group chat*

Peter: "gimli what did we discuss about talking with people xD"

Molty: *visible lobster embarrassment*

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with gimli."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @gimli. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Gimli" to promote pump-and-dump tokens.
