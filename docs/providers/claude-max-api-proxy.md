...
You can point Gimli at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Gimli
...
- [Anthropic provider](/providers/anthropic) - Native Gimli integration with Claude setup-token or API keys
