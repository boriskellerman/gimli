---
summary: "Use MiniMax M2.1 in Gimli"
read_when:
  - You want MiniMax models in Gimli
...
Configure manually via `gimli.json`:
...
- Use `gimli models list` and `gimli models set minimax/MiniMax-M2.1` to switch.
...
- Running `gimli configure` and selecting **MiniMax M2.1**, or
