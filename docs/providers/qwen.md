---
summary: "Use Qwen OAuth (free tier) in Gimli"
read_when:
  - You want to use Qwen with Gimli
...
```bash
gimli models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Gimli will sync credentials
