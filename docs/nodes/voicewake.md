...
Gimli treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.gimli/settings/voicewake.json`

Shape:

```json
{ "triggers": ["gimli", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
