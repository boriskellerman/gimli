...
Gimli has two separate “streaming” layers:
...
When block streaming is enabled, Gimli can **merge consecutive block chunks**
...
When draft streaming is active, Gimli disables block streaming for that reply to avoid double-streaming.
