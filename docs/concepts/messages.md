...
This page ties together how Gimli handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Gimli keeps a
...
Gimli separates the **prompt body** from the **command body**:
...
Gimli can expose or hide model reasoning:
