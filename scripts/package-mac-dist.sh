...
# Output:
# - dist/Gimli.app
# - dist/Gimli-<version>.zip
# - dist/Gimli-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Gimli-$VERSION.zip"
DMG="$ROOT_DIR/dist/Gimli-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Gimli-$VERSION.notary.zip"
