...
show_usage() {
    cat << EOF
clawlog - Gimli Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Gimli logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Gimli logs flow through the macOS unified log (subsystem: bot.molt).
