## Gimli Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_gimli-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm gimli gateway --port 18789 --verbose
```
