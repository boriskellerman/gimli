...
public typealias GimliPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias GimliPlatformImage = UIImage
#endif

public struct GimliChatUsageCost: Codable, Hashable, Sendable {
...
public struct GimliChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: GimliChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(GimliChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct GimliChatMessageContent: Codable, Hashable, Sendable {
...
public struct GimliChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [GimliChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: GimliChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [GimliChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: GimliChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(GimliChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([GimliChatMessageContent].self, forKey: .content) {
...
public struct GimliChatHistoryPayload: Codable, Sendable {
...
public struct GimliSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct GimliSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [GimliSessionPreviewItem]
}

public struct GimliSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [GimliSessionPreviewEntry]

    public init(ts: Int, previews: [GimliSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct GimliChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct GimliChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct GimliAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct GimliChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct GimliGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct GimliPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: GimliPlatformImage?
...
public struct GimliChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
