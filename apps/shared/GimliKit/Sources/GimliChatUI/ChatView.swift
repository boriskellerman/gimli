...
@MainActor
public struct GimliChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: GimliChatViewModel
    ...
    private var visibleMessages: [GimliChatMessage] {
        let base: [GimliChatMessage]
    ...
    private func mergeToolResults(in messages: [GimliChatMessage]) -> [GimliChatMessage] {
    ...
    private func isToolResultMessage(_ message: GimliChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: GimliChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: GimliChatMessage) -> String {
