...
public enum GimliCanvasA2UICommand: String, Codable, Sendable {
...
public struct GimliCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct GimliCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
