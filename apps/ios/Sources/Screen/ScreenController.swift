...
final class ScreenController {
    ...
    /// Callback invoked when a gimli:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = GimliKitResources.bundle
...
/// Handles navigation policy to intercept gimli:// deep links from canvas
@MainActor
