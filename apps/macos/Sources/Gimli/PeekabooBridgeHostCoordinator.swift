...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: GimliPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = GimliPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.gimliSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.gimliSocketPath, privacy: .public)")
    }
...
@MainActor
private final class GimliPeekabooBridgeServices: PeekabooBridgeServiceProviding {
