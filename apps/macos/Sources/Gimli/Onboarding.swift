...
enum UIStrings {
    static let welcomeTitle = "Welcome to Gimli"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: GimliOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: GimliChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g gimli@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: GimliChatViewModel(
