...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Gimli token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: GimliOAuthStore.AnthropicOAuthStatus = GimliOAuthStore
...
enum GimliOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let gimliOAuthDirEnv = "GIMLI_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Gimli OAuth token file not found"
            case .unreadableFile: "Gimli OAuth token file not readable"
            case .invalidJSON: "Gimli OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Gimli OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Gimli OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.gimliOAuthDirEnv]?
