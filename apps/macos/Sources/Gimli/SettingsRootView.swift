...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .gimliSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? GimliPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? GimliPaths.stateDirURL.path
...
extension Notification.Name {
    static let gimliSelectSettingsTab = Notification.Name("gimliSelectSettingsTab")
}
